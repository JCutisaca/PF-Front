  ...
  const [messages, setMessages] = useState([
    {
      text: <div>
        ...
        - <strong>Email: </strong> Para obtener nuestro email <br />
  ...
  const handleUserMessage = (message) => {
    if (message.trim() !== "") {
      ...
      switch (message.toLowerCase()) {
        case "email":
          botResponse = <div>Nuestro email es {emailLink()}.<br /> ¿Puedo ayudarte en algo mas?<br />Puedes responder con <strong>si</strong> o  <strong>no</strong></div>
          break
        case "telefono":
        case "teléfono":
        ...
        case "informacion sobre el stock":
          botResponse = <div>Todos los productos publicados cuentan con stock disponible, en caso de no tener stock no vas a poder acceder al producto.<br />¿Puedo ayudarte en algo mas?<br />Puedes responder con <strong>si</strong> o  <strong>no</strong></div>
          break;
